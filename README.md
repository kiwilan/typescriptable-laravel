...
If you want to use some helpers with [Inertia](https://inertiajs.com/), you can install associated NPM package, [`@kiwilan/typescriptable-laravel`](https://github.com/kiwilan/typescriptable-laravel/tree/main/lib).
