...
-   [tightenco/ziggy](https://github.com/tighten/ziggy) for `composer` (optional for `typescriptable:ziggy` command)
-   [ziggy-js](https://www.npmjs.com/package/ziggy-js) for `npm` (optional for `typescriptable:ziggy` with `embed` option)
-   [@kiwilan/vite-plugin-steward-laravel](https://www.npmjs.com/package/@kiwilan/vite-plugin-steward-laravel) for `npm` (optional for `typescriptable:ziggy` with `embed` option, `kiwilan/steward-laravel` package is not required)
